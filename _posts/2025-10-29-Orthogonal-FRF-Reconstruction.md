...
## Experimental Setup and Measurement Overview

Measurements were performed at several angular positions using both accelerometer and vibrometer setups.  
The following figures present representative FRF magnitude comparisons for selected measurement angles.
...
*Comparison of orthogonal accelerometer and vibrometer measurements at 0°.*
...
*Comparison between accelerometer and vibrometer FRFs at 47.9°.*
...
*Measured tri-axial accelerometer response across the frequency range.*
...
*Reconstructed FRF magnitudes comparing orthogonal (black), angled (red), and projected (blue) results.*

> **Info:** All plots are presented using a logarithmic scale for amplitude (m/s²/N) and a linear scale for frequency (Hz).
{: .alert .alert-info }
